...
*				Mise en évidence des effets d'un débordement d'indice 	*
* Auteur : Eric Merlet													*
* Date : 10/10/2013														*
************************************************************************/
...
int main()
{
    ...
    cout << "Adresse de la variable j : " << &j << endl;
	...
	// Acces à des cases memoires non reservees par le programme : A PAS FAIRE
    Notes [3] = 250;
	return 0;
}